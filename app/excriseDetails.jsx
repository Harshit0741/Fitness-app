...
export default function excriseDetails() {
  ...
  return (
    <View className='flex flex-1'>
        ...
        >
          <Anticons name="closecircle" size={hp(3.5)} color='#f43f5e' />
        </TouchableOpacity>
        ...
        <ScrollView className='mx-4 space-y-2 mt-3' showsVerticalScrollIndicator={false} contentContainerStyle={{paddingBottom: 60}}>
          ...
          <Animated.Text
            entering={FadeInDown.delay(200).duration(300).springify()}Text
            style={{fontSize: hp(2)}}
            className=' text-neutral-700 tracking-wide'
          >
          ...
          <Animated.Text
            ...
            className=' text-neutral-700 tracking-wide'
          >
            Target Muscles <Text className='font-bold text-neutral-800'>
              {item?.target}
            </Text>
          </Animated.Text>
          <Animated.Text
